...
| [024b](../insights/022-feedforward-tmaze-solver-is-compact-not-a-delay-line.md) | fixed topology inspection | isolate solver (fitness now persisted); XOR control | [022 raw](../insights/022-raw-tmaze-solver-topology.txt) | [022](022-feedforward-tmaze-solver-is-compact-not-a-delay-line.md) | done — **solver is COMPACT (3 neurons), not a delay line**; controls inconclusive (my XOR control mis-designed) |
| [024c](../insights/023-delay-line-confirmed-memory-is-a-chain-computation-is-a-dag.md) | dump solver wiring | connections+weights; XOR control with deep tuner | [023 raw](../insights/023-raw-solver-wiring.txt) | [023](023-delay-line-confirmed-memory-is-a-chain-computation-is-a-dag.md) | done — **delay-line CONFIRMED**: memory solver=linear chain, XOR solver=convergent DAG |
| 024d | signal-flow trace + more solvers | watch cue advance one chain-stage/cycle; n>1 solvers per condition | — | — | turns "structurally a delay line" into "dynamically", and n=1 into statistics |
