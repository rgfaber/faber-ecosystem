...
| 022 | T-maze delay sweep (2/8/16) | characterise the delay-line variant's capacity | — | 022 (pending) | **next: confirm delay-line hypothesis + get a clean no-memory baseline** |
