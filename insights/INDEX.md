...
- **P4 — Objectives** (OPENED 2026-07-23, insight 050): Quality-Diversity / selection pressure. Deception leg is MOOT (028 resolved DPNV to optimizer+representation); P4 opens on QD illumination. 050 = first QD machinery + a modest illumination advantage, no peak advantage on an easy task. [`CHARTER_P4_OBJECTIVES.md`](../plans/CHARTER_P4_OBJECTIVES.md).
