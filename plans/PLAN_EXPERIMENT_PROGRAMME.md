...
| 024c | trace the 3-neuron solver | dump connections+weights, trace per-cycle signal flow; redo XOR control with DEEP tuner | — | — | the only thing that closes the feedforward-memory mechanism |
