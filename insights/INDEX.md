...
| [057](057-embodied-pursuit-evasion-coevolves-monotonically-no-cycling-pursuer-sustains-evader-marginal.md) | P7 EMBODIED rung: real [2,6,4] nets coevolving on 9x9-torus pursuit-evasion at THREE crossover brackets (m=14/13/12) make MONOTONE progress with NO cycling (master-tournament triples=0 at bands 0.05-0.15); the PURSUER sustains net frozen-benchmark progress at all three and MORE with its speed edge (0.151->0.189->0.238, extreme-pair resolved), the EVADER is a STEP not a gradient (sustains evader-fav m=14, marginal on both pursuer-fav m=13/12; cross-crossover difference unresolved at n=40); a DECOUPLED CONTROL (two static baselines, reproduced to n=80) refuses coevolutionary coupling over a DIVERSE opponent (coevo ties a frozen-random opponent; a n=60 pursuer hint did not reproduce at n=80; it beats a NARROW strong opponent but that is curriculum-diversity, not coupling) -- so two-sided PROGRESS, NOT an arms race | confirmed (monotone, no cycling; pursuer sustains) + refuted (no coupling over a diverse static opponent; not an arms race) + method (benchmark-grading fix + 2 CLAIM gates + decoupled control x2 baselines, reproduced) | 2026-07-23 |
