...
| [057](057-embodied-pursuit-evasion-coevolves-monotonically-no-cycling-pursuer-sustains-evader-marginal.md) | P7 EMBODIED rung: real [2,6,4] nets coevolving on 9x9-torus pursuit-evasion at both crossover brackets make MONOTONE progress with NO cycling (master-tournament triples=0 at bands 0.05-0.15, later-dominates-earlier 25-29 vs 0-1); on a verified-graded frozen benchmark the PURSUER sustains net progress at both (+0.151,+0.189), the EVADER is MARGINAL (+0.153 vs +0.042 CI-includes-0, between-bracket diff unresolved); clear two-sided PROGRESS but a sustained arms race is NOT established and reciprocal driving untested (needs decoupled control) | confirmed (monotone, no cycling; pursuer sustains) + partial (evader marginal, coupling untested) + method (benchmark-grading fix + 2 CLAIM gates) | 2026-07-23 |
