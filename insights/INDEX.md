...
- **P7 — Coevolution / Self-play** (OPENED 2026-07-23, insights 053-054): interaction, arms races, open-endedness, toward Flatland/ALife. A GRADUAL ladder (smallest steps first): 053 = the Red Queen (co-fitness blind to progress, use a fixed benchmark); 054 = but a fixed benchmark must be GRADED (a too-weak one saturates and goes blind). Next rungs: benchmark ALIGNMENT (decoupled-scoring ranking test), intransitive/cycling, disengagement, then neural embodied pursuit-evasion. Methodology built rung by rung before betting it on the embodied game. [`CHARTER_P7_COEVOLUTION.md`](../plans/CHARTER_P7_COEVOLUTION.md).
