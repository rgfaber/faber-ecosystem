...
| [057](057-embodied-pursuit-evasion-coevolves-monotonically-no-cycling-pursuer-sustains-evader-marginal.md) | P7 EMBODIED rung: real [2,6,4] nets coevolving on 9x9-torus pursuit-evasion at both crossover brackets make MONOTONE progress with NO cycling (master-tournament triples=0 at bands 0.05-0.15); the PURSUER sustains net frozen-benchmark progress at both (+0.151,+0.189), the EVADER is MARGINAL (+0.153 vs +0.042 CI-includes-0); a DECOUPLED CONTROL refuses coevolutionary coupling (coevo NET does not exceed a frozen static opponent on any side/bracket) -- so two-sided PROGRESS, NOT a demonstrated arms race | confirmed (monotone, no cycling; pursuer sustains) + refuted (no coupling over static control; not an arms race) + method (benchmark-grading fix + 2 CLAIM gates + decoupled control) | 2026-07-23 |
