...
- **P7 — Coevolution / Self-play** (OPENED 2026-07-23, insight 053): interaction, arms races, open-endedness, toward Flatland/ALife. A GRADUAL ladder (smallest steps first): 053 = the Red Queen on a 1D numbers game (co-fitness blind to progress, a fixed benchmark is needed); next rungs 2D transitive (benchmark-fidelity), intransitive/cycling, disengagement, then neural embodied pursuit-evasion. [`CHARTER_P7_COEVOLUTION.md`](../plans/CHARTER_P7_COEVOLUTION.md).
